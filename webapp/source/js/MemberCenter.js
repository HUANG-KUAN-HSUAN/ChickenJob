...
{   
   ...
   if(window.ActiveXObject)
	...
	// 設置請求方式和 URL
	 xmlHTTP.open("GET", "http://localhost:8080/JavaBean/Update_password?"+
	 					"user_password="+PW+
	 					"&new_password="+newPW
	 					+"&user_id="+id, true);
...
{   
	...
	// 設置請求方式和 URL
	 xmlHTTP.open("GET", "http://localhost:8080/JavaBean/Update_personal_data?"+
	 					"user_id="+id+
	 					"&user_name="+name+
	 					"&phone="+phoneNumber
	 					+"&gender="+gender
...
{   
    ...
    xmlHTTP.open("GET", "http://localhost:8080/JavaBean/Update_post_job?"+
    					"user_id="+id+
	 					"&job_name="+job_name+
	 					"&job_info="+job_info+
	 					"&job_city="+job_city+
...
function accept(link)
{
	...
	xmlHTTP.open("GET", "http://localhost:8080/JavaBean/OfferJob?"+
    					"user_id="+user_id+
	 					"&job_id="+job_id+
