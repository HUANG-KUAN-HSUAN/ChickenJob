function citySelect()
{
	...
	// 設置請求方式和 URL
	 xmlHTTP.open("GET", "http://localhost:8080/JavaBean/GetCityForNewJob", true);
...
function getDistrict() {
  ...
  if(window.ActiveXObject)
	...
	// 設置請求方式和 URL
	 xmlHTTP.open("GET", "http://localhost:8080/JavaBean/GetDistrictForNewJob?selectedCity=" +selectedCity , true);
